...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="主页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 60px"><font color="blue" size="7">欢迎南师大租户信息数据管理后台</font></div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <div title="招商部"  data-options="selected:true,iconCls:'icon-fwcl'" style="padding:10px">
            <a href="javascript:openPage('招商信息录入','addInvestmentInfo.jsp','icon-fwfk')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">招商信息录入</a>
        ...
        <div title="财务部" data-options="iconCls:'icon-yxjhgl'" style="padding: 10px">
            <a href="javascript:openPage('财务信息录入','addFinanceInfo.jsp','icon-taocan')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-taocan'" style="width: 150px;">财务信息录入</a>
        ...
        <div title="物业部"  data-options="iconCls:'icon-cpxxgl'" style="padding:10px;">
            <a href="javascript:openPage('水电信息录入','addHydropowerInfo.jsp','icon-khxxgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khxxgl'" style="width: 150px;">水电信息录入</a>
        ...
        <div title="办公室"  data-options="iconCls:'icon-fwgl'" style="padding:10px">
            <a href="javascript:openPage('审核','check.jsp','icon-khgxfx')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khgxfx'" style="width: 150px;">审核</a>
            <a href="javascript:openPage('文件上传','fileUpload.jsp','icon-fwgd')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-khgcfx'" style="width: 150px;">文件上传</a>
        </div>

        <div title="系统管理"  data-options="iconCls:'icon-item'" style="padding:10px">
            <a href="javascript:openPage('用户管理','userManage.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">用户管理</a>
